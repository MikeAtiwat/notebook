...
define([
    ...
    ButtonSideBar.prototype.bind_events = function () {
        ...
        if(!open_true){
        document.getElementById("mySidebar").style.width = "1500px";
        // document.getElementById("main").style.marginRight = "250px";
        document.getElementById("site").style.marginRight = "1500px";
        document.getElementById("notebook_panel").style.marginRight = "1500px";
        document.getElementById("header").style.marginRight = "1500px";
        this.open = true;
      }else{
