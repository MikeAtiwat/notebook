...
define([
    ...
    ButtonSideBar.prototype.bind_events = function () {
        ...
        document.getElementById("site").style.marginRight = "500px";
        document.getElementById("notebook_panel").style.marginRight = "500px";
        document.getElementById("header").style.marginRight = "500px";
        this.open = true;
      }else{
